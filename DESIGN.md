...
- **Mono** handles technical data: part numbers (`PN-7842-A3`), tolerances (`±0.05mm`), feature IDs, query strings, file paths, source citations on slides, eyebrow labels, and any string an engineer would copy/paste verbatim.
...
| Eyebrow Label | 11px | 600 | 1.00 | 1.5px (uppercase) | Mono | Slide eyebrows, section tags, citations |
...
- **Mono as a meaning-bearing typeface.** Switching to mono is a deliberate signal: "this is precise, machine-relevant data, not prose." Never use mono for ornament.
...
- Eyebrow label, top-left: mono 11px uppercase, primary teal accent
...
- Source citation, bottom-left: mono 11px, secondary gray
